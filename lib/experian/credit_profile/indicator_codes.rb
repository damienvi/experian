module Experian
  module CreditProfile
    module IndicatorCodes
      ...
      OFAC_MLA_INDICATOR = 57

      OFAC_CODES = {
        1200=>"NAME MATCHES OFAC/PLC/FSE LIST",
        1201=>"OFAC LIST TEMPORARILY UNAVAILABLE",
        1202=>"NAME DOES NOT MATCH OFAC/PLC/FSE LIST"
      }
      OFAC_HIT = 1200

      MLA_CODES = {
        1203=>"MLA COVERED BORROWER",
        1204=>"NON-MLA COVERED BORROWER",
        1205=>"MLA LOOKUP TABLE TEMPORARILY UNAVAILABLE",
        1206=>"MLA SEARCH NOT ALLOWED FOR THIS REQUEST",
        1207=>"MLA SEARCH NOT PERFORMED DUE TO MISSING REQUIRED DATA"
      }
